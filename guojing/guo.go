...
func (*GuoJob) TableName() string {
	return "v2_guokao_jingkao_table"
}
func main() {
	...
	type1 := "国考"
	type2 := "中央国家行政机关参照公务员法管理事业单位" //国考更改（sheet名）
	// 获取 Sheet1 上所有单元格
	...
	var count int64
	db.Table("v2_guokao_jingkao_table").Count(&count)
	...
	tx.Table("v2_guokao_jingkao_table").Count(&count2)
